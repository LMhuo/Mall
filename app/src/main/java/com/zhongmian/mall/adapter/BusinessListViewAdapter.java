...
public class BusinessListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.business_listview_item, parent, false);
            viewHolder.imageView = (ImageView) convertView.findViewById(R.id.imageView_listView_business);
            viewHolder.textViewName = (TextView) convertView.findViewById(R.id.textView_listView_business_name);
            viewHolder.textViewPrice = (TextView) convertView.findViewById(R.id.textView_listView_business_price);
